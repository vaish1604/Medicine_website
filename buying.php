            ...
            <div class="row h-100 align-items-center">
                <div class="col-md-7">
                    <div class="header-content">
                        ...
                        <h4 class="header-subtitle">Enter Medicine Name</h4>
                        <!-- <button class="btn btn-outline-light btn-flat">Download</button> -->
                    </div>  
                </div>
                <div class="col-md-5 d-none d-md-block">
                    <form class="header-form" method="POST" action="sell.php">
                        ...
                        <div class="body">
                            ...
                            <button class="btn btn-primary btn-block" type="submit" onclick="sell()">Buy</button>
                        </div>                       
                    </form> 
                    <br><br>
                </div>
