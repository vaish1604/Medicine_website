        ...
        <div class="container">
            <div class="row h-100 align-items-center">
                <div class="col-md-7">
                    ...
                    <a class="navbar-brand" href="#"><strong class="text-primary" id="tit">SELECT YOUR </strong><span class="text-light">MEDS</span></a>
                    <table class="table" id="t">
                            <thead>
                                ...
                                <?php
                                    ...
                                    $sel='select * from meds';
                                    $sq=mysqli_query($con,$sel);
                                    while($row=mysqli_fetch_array($sq)){
                                        echo "<tr><td>" . $row['name'] . "</td><td> " . $row['price'] . "</td><td> " .'<button class="btn btn-outline-light btn-flat" onclick=buy("'.$row['name'].'","' .$row['name'] . '")>Buy</button>' . "</td></tr>";
                        ...
                        <a class="btn btn-primary btn-block" href="details.php">NEXT</a> 
                </div>
            </div>  
        </div>
    </header>
